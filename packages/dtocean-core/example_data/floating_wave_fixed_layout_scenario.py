...
max_100year_hs = 0.5
max_100year_tp = 2.5
max_100year_gamma = 3.3

spectrum_type_farm = 'JONSWAP'
spectrum_gamma_farm = 3.3
spectrum_dir_spreading_farm = 30.
...
max_50_year_water_level = 1.0 #water level maximum offset
min_50_year_water_level = -1.0 #water level minimum offset
...
umbilical_connection = [0., 3. , 25.]
umbilical_safety = 2.

power_factor = 0.98
                
sys_prof = "Cylindrical"   #device profile options: "Cylindrical" "Rectangular"
sys_mass = 1500000 #device mass
sys_cog = [0.0, 0.0, 20.0] #device centre of gravity
sys_vol = 3000. #device displaced volume
sys_height = 38.0 #device height
sys_width = 10.0 #device width
sys_length = 10.0 #device length
sys_draft = 30.0 #device draft
sys_dry_frontal = 48.0 #device dry frontal area
sys_dry_beam = 48.0 #device dry beam area
sys_wet_frontal = 180.0 #device wet frontal area
sys_wet_beam = 180.0 #device wet beam area
...
fairlead_loc = np.array([[-3.0,               0.0, 20.],
                         [ 1.5,  1.5 * np.sqrt(3), 20.],
                         [ 1.5, -1.5 * np.sqrt(3), 20.]])
                      
depvar = False # is the device submersible?
...
found_safety = 1.0 #foundation safety factor
grout_safety  = 1.0 #grout safety factor
fab_cost = None # 1.0 #optional fabrication cost factor

## MOORINGS

moorsfuls = 1.0 #mooring ultimate limit state safety factor
moorsfals = 1.0 #mooring accident limit state safety factor
maxdisp = [100.0, 100.0, 30.0] #device maximum displacements in surge, sway and heave
