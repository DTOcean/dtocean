...
from dtocean_core.utils.hydrodynamics.tidestats import (make_tide_statistics,
                                                        _get_nearest_xy_idx,
...
@pytest.mark.parametrize("xc, yc, xexp, yexp", 
...
@pytest.mark.parametrize("interval, minexp, maxexp", 
                         [(0.1, -0.05, 2.05),
