...
def test_Histogram_equals():
    a = {"values": [1, 2, 3, 4, 5], "bins": [0, 2, 4, 6, 8, 10]}
    b = {"values": [1, 2, 3, 4, 5], "bins": [0, 2, 4, 6, 8, 10]}
...
def test_Histogram_equals_numpy():
    ...
    a = {"values": values_one, "bins": bins_one}
    b = {"values": values_two, "bins": bins_two}
...
def test_Histogram_not_equals():
    a = {"values": [1, 2, 3, 4, 5], "bins": [0, 2, 4, 6, 8, 10]}
    b = {"values": [1, 2, 3, 4], "bins": [0, 2, 4, 6, 8]}
...
def test_Histogram_not_equals_numpy():
    ...
    a = {"values": values_one, "bins": bins_one}
    b = {"values": values_one, "bins": bins_two}
