...
@pytest.mark.parametrize(
    "tinput, ttype",
    [(1.0, "int"), (True, "str"), ("False", "bool"), (2, "float")],
)
...
@pytest.mark.parametrize("tinput, ttype", [(1, "int"), (1.0, "float")])
...
@pytest.mark.parametrize(
    "left, right", [(1, 1), ("a", "a"), (False, False), (2.1, 2.1)]
)
...
@pytest.mark.parametrize(
    "left, right", [(1, 2), ("a", "b"), (False, True), (2.1, 2.101)]
)
