...
class VisualisePerformanceFit:
    ...
    def show_pto(self):
        ...
        return self.general_plot(
            val, dofi, dofi, "dof i", "dof j", "Damping, [-]"
        )
    ...
    def show_mooring(self):
        ...
        return self.general_plot(
            val, dofi, dofi, "dof i", "dof j", "Stiffness, [-]"
        )
    ...
    def show_scatter_diagram(self, a_i):
        ...
        return self.general_plot(
            val, te, hm0, "Te, [s]", "Hm0, [m]", "Probability, [-]"
        )
