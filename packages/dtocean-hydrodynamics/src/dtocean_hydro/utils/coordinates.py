...
def wgs2utm(Lat, Lon, *arg):
    ...
    M = a * (
        (1 - e**2.0 / 4 - 3 * e**4.0 / 64 - 5 * e**6.0 / 256) * lat
        - (3 * e**2.0 / 8 + 3 * e**4.0 / 32 + 45 * e**6.0 / 1024)
        * np.sin(2 * lat)
        + (15 * e**4.0 / 256 + 45 * e**6.0 / 1024) * np.sin(4 * lat)
        - (35 * e**6.0 / 3072) * np.sin(6 * lat)
    )
    ...
    x = FE + k0 * N * (
        A
        + (1 - T + C) * A**3.0 / 6
        + (5 - 18 * T + T**2 + 72 * C - 58 * eps) * A**5.0 / 120
    )
    ...
    y = (
        ...
        * (
            A**2.0 / 2
            + (5 - T + 9 * C + 4 * C**2) * A**4.0 / 24
            + (61 - 58 * T + T**2 + 600 * C - 330 * eps) * A**6.0 / 720
        )
    )
