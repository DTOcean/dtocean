...
def tidalsite():
    ...
    leaseAreaVertexUTM = np.array(
        [[50.0, 50.0], [950.0, 50.0], [950.0, 500.0], [50.0, 500.0]],
        dtype=float,
    )
...
def tidalsite_simple():
    ...
    # Lease Area
    leaseAreaVertexUTM = np.array(
        [[50.0, 50.0], [950.0, 50.0], [950.0, 250.0], [50.0, 250.0]],
        dtype=float,
    )
...
def wavesite():
    leaseAreaVertexUTM = (
        np.array(
            [[0, 0], [1000.0, 0], [1000.0, 300.0], [0, 300.0]], dtype=float
        )
        - 1.0
    )
