...
@pytest.mark.parametrize(
    "test_coords, expected",
    [
        (np.array([[0.0, 0.0]]), False),
        (np.array([[0.0, 0.0], [0.0, 11.0]]), False),
        (np.array([[0.0, 0.0], [11.0, 0.0]]), False),
        (np.array([[0.0, 0.0], [11.0, 11.0]]), False),
        (np.array([[0.0, 0.0], [0.0, 1.0]]), True),
        (np.array([[0.0, 0.0], [1.0, 0.0]]), True),
        (np.array([[0.0, 0.0], [1.0, 1.0]]), True),
    ],
)
...
def test_generator():
    ...
    arr = Array_pkg(lease, lease * 1.05, (10, 10), np.pi / 4)
