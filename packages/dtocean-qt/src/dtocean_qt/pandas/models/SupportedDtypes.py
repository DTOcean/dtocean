...
class SupportedDtypesTranslator(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._ints = [
            (np.dtype(np.int8), self.tr("small integer (8 bit)")),
        ...
        self._uints = [
            (np.dtype(np.uint8), self.tr("unsigned small integer (8 bit)")),
        ...
        self._floats = [
            (np.dtype(np.float16), self.tr("floating point number (16 bit)")),
