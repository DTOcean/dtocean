...
class InterfaceFactory:
    ...
    def has_connect_method(self, data_obj):
        ...
        result = result and not hasattr(
            data_obj, "_{}".format(self._AutoCls.get_connect_name())
        )
    ...
    def __call__(self, metadata, data_obj):
        if not self.has_connect_method(data_obj):
            ...
            errStr = (
                "Given structure does not contain the required {} "
        ...
        NewInterface = type(new_id, (self._AutoCls,), abstract_dict)
