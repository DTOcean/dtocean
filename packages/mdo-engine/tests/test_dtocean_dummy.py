...
def test_get_next_interface(controller):
    ...
    controller.sequence_interface(new_sim, "demo_hub", "Spreadsheet Generator")
...
def test_input_status(controller):
    ...
    input_status = controller.get_input_status(
        pool, new_sim, "demo_hub", "Spreadsheet Generator"
    )
...
def test_input_status_overwritten(controller):
    ...
    controller.sequence_interface(new_sim, "demo_pipe", "Spreadsheet Generator")

    controller.sequence_interface(new_sim, "demo_pipe", "Later Interface")

    input_status = controller.get_input_status(
        pool, new_sim, "demo_pipe", "Later Interface"
    )
...
def test_input_status_trigger(catalog, controller):
    ...
    controller.add_datastate(
        pool, new_sim, "input", catalog, ["trigger.bool"], [True]
    )
...
def test_demo_status(catalog, loader, controller):
    ...
    test_inputs = {"demo:demo:low": 1, "demo:demo:high": 2, "demo:demo:rows": 5}
    ...
    f_interface = controller.get_interface_obj(
        new_sim, "demo_hub", "Spreadsheet Generator"
    )
    ...
    controller.add_datastate(
        pool, new_sim, "input", catalog, data_indentities, data_values
    )

    f_interface = loader.load_interface(pool, new_sim, f_interface)

    input_status = controller.get_input_status(
        pool, new_sim, "demo_hub", "Spreadsheet Generator"
    )

    output_status = controller.get_output_status(
        new_sim, "demo_hub", "Spreadsheet Generator"
    )
    ...
    controller.set_interface_completed(
        new_sim, "demo_hub", "Spreadsheet Generator"
    )
    ...
    input_status_values = set(input_status.values())
    output_status_values = set(output_status.values())
    table = controller.get_data_value(pool, new_sim, test_variable)
...
def test_merge_states(catalog, loader, controller):
    ...
    test_variable = "demo:demo:table"
    test_inputs = {"demo:demo:low": 0, "demo:demo:high": 1, "demo:demo:rows": 5}
...
def test_check_next_interface(catalog, loader, controller):
    ...
    controller.sequence_interface(new_sim, "demo_hub", "Later Interface")
    ...
    controller.check_next_interface(
        new_sim, "demo_hub", "Spreadsheet Generator"
    )
...
def test_masked_states(catalog, loader, controller):
    ...
    controller.add_datastate(
        pool, new_sim, "input", catalog, ["trigger.bool"], [False]
    )
...
def test_nullify_data(catalog, loader, controller):
    ...
    controller.add_datastate(
        ...
        "executed",
        catalog,
        ["trigger.bool", "trigger.bool", "trigger.bool"],
        [None, True, None],
    )
