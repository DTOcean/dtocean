...
def test_get_data_value(loader, controller, catalog):
    ...
    new_data_value = loader.get_data_value(
        pool, new_sim, "Technology:Common:DeviceType"
    )
...
def test_create_merged_state(loader, controller, catalog):
    ...
    test_inputs = {"demo:demo:high": 2, "demo:demo:rows": 5}
    ...
    controller.add_datastate(
        pool, new_sim, "input2", catalog, ["demo:demo:low"], [1]
    )
