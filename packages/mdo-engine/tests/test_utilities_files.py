...
from mdo_engine.utilities.files import mkdir_p, xl_to_data_yaml, xl_to_dds
...
def test_xl_to_dds():
    ...
    dds = xl_to_dds(test_xl_path, ignore_column="Comments")
...
def test_xl_to_data_yaml(tmpdir):
    ...
    xl_to_data_yaml(test_xl_path, test_yaml_path)
