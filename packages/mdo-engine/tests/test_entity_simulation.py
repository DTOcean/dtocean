...
from mdo_engine.control.simulation import Controller
...
def test_undo_state(controller):
    ...
    controller.sequence_interface(new_sim, "dummy_hub", "Early Interface")
    ...
    f_interface = controller.get_interface_obj(
        new_sim, "dummy_hub", "Early Interface"
    )
    ...
    controller.add_datastate(
        pool, new_sim, "executed", catalog, ["early:dummy:data"], [raw_data]
    )
