...
class SiteSelectionWidget(InputWidgetInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list = ["site.available_names", "site.selected_name"]
    ...
    def declare_id_map(self):
        ...
        id_map = {
            "available": "site.available_names",
    ...
    def connect(self):
        input_widget = ListSelect(self.parent, self.data.available)
...
class SystemSelectionWidget(InputWidgetInterface):
    ...
    def declare_inputs(cls):
        ...
        input_list = ["device.available_names", "device.selected_name"]
    ...
    def declare_id_map(self):
        ...
        id_map = {
            "available": "device.available_names",
