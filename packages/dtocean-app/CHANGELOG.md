...
- Release version 4
  ([`0cc9260`](https://github.com/DTOcean/dtocean/commit/0cc9260581b0fac9f61c85ba4a0d203ad16618da))
...
- Added desktop shortcut creation as part of "dtocean init" command

### Bug Fixes

- Convert dates to Python format when copying to clipboard

### Changed

- Tool and strategy GUI definitions are now defined in the
  dtocean_plugins.strategy_guis and dtocean_plugins.tool_guis namespaces,
  respectively.
- Widgets are now generated at build time from ui files
- dtocean_app.main was split into dtocean_app.shell and dtocean_app.window
- Moved dtocean-app CLI tool functionality to "dtocean app"
- The About dialog was updated to remove outdated information and include
  dynamically generated software version information
- Removed use of pickle in save files and changed extension to "dtox"

### Removed

- Remove support for Python version 2.7
- Moved tool and strategy GUI definitions into providing packages
- Removed dtocean_app.utils.SmartFormatter as it was duplicate code
- Removed documentation installation configuration files as this is now
  managed by the dtocean-docs packages
- Remove version number (i.e. 2) from the loading splash
- Removed tkinter as a dependency (not always included in Linux Python builds)
