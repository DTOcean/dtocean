# -*- coding: utf-8 -*-
#
# dtocean-doc documentation build configuration file, created by
...
project = "DTOcean"
copyright = f"2016-{now.year} The DTOcean Developers"
...
htmlhelp_basename = "DTOcean User Manual"
...
latex_documents = [
    ("index", "dtocean_manual.tex", "DTOcean Manual", "", "manual"),
]
...
man_pages = [(master_doc, "dtocean-doc", "DTOcean User Manual", [author], 1)]
